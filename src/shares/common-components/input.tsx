...
const inputVariants = cva(
  'w-full px-4 py-2 focus:ring-0 focus:outline-none text-body-2',
  {
    variants: {
      variant: {
        default:
          'bg-transparent rounded-lg border border-gray-300 focus:border-black placeholder-grey03 h-14',
        error:
